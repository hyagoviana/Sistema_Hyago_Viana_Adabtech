...
**Próximo no R2:** R2-05 (criar caso escolhe tema+frente + case_code por tema) → R2-07 (campos por tema/frente — migrar defs FIES de R5-06) → R2-08 (Kanban+Lista com filtro de frente). R2-02 (backfill/fusão dos legados) **espera a lista do cliente**. R1-04/R1-05 entram aqui. Com R2-01/03/04/06, o admin já cria tema→frentes→pastas; falta R2-05 (o cadastro do caso usar tema+frente).
