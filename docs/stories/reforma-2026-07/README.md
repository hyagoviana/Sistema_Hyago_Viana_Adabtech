...
**🎉 FLUXO MANUAL DO R2 COMPLETO** (R2-01/03/04/05/06): admin cria tema→frentes→vincula pastas/modelos; pipeline nasce semeada; operador cria caso por tema+frente (puxa docs/checklist da frente); case_code por tema. **Próximo:** R2-07 (campos personalizados por tema/frente — migrar defs FIES de R5-06) → R2-08 (UX Kanban↔Lista: toggle explícito + Lista "Excel" + `?tema=`). R2-02 (fusão dos legados FIES) **espera a lista do cliente**. R1-04/R1-05 entram aqui.
