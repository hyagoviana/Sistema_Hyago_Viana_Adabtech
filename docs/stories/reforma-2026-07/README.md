...
**Próximo:** R2-08 (UX Kanban↔Lista: toggle explícito + Lista "Excel" + `?tema=` + agregação N service_types). R2-02 (fusão dos legados FIES) **espera a lista do cliente**. R1-04/R1-05 entram aqui. Com R2-07, o admin já configura campos por tema/frente e a ficha do caso os renderiza.
