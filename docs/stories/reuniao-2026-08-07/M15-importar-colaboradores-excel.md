...
- **Status:** **Ready (planilha recebida)** — a planilha preenchida chegou (`docs/reunioes/Cadastro-Colaboradores-PREENCHIDO-2026-08-08.xlsx`). Pendências que restam: **telefones** (Thiago manda depois — coluna veio em branco), **confirmação Bruno=Maxwel / Hudson=Wdyson** (complexidade) e os **14 tipos** (pontuação — outra story). Nenhuma dessas bloqueia o importador de usuários/permissões/mapping.
