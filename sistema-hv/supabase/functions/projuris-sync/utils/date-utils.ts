/**
 * Utilidades de Data — Motor de Distribuicao v1.0
 *
 * Operacoes de data com timezone America/Sao_Paulo (CON-006).
 * Dia operacional = seg-sex sem bloqueio geral no calendario.
 *
 * Story 1.4 — Epic 1
 */

import type { CalendarDay } from '../config/types.ts';
...
// ---------------------------------------------------------------------------
// Helpers basicos de data (sem dependencia externa)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Calendario operacional (AC-07, AC-15)
// ---------------------------------------------------------------------------
 ...
 * AC-07
 */
export function getOperationalDays(
  from: string,
  to: string,
 ...
 * D+N: avanca N dias operacionais.
 */
 ...
 * dist_op_days(B, L) conforme spec.
 */
