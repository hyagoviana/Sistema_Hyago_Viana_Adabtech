 ...
 *
 * PORTE Node do engine puro (fonte: supabase/functions/projuris-sync/config/types.ts).
 * Tipos TypeScript alinhados ao JSON Schema v1.0. Zero dependencia de runtime
 * (sem Deno.* / npm:). Ver src/rpc/distribuicao.ts para o orquestrador Node.
 */
