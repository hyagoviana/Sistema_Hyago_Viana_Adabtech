...
export function CaseCard({
  ...
  return (
    <Link
      to="/casos/$id"
      params={{ id: caso.id }}
      className="block bg-white rounded-lg border border-[rgba(30,32,68,0.08)] p-3.5 hover:-translate-y-0.5 hover:border-[rgba(30,32,68,0.18)] hover:shadow-md transition-all group"
    >
